...
function Footer() {
  return (
    <section className="relative overflow-hidden bg-white py-8 mt-auto">
          ...
          <div className="w-auto p-8">
            <a href="/">
              <div className="inline-flex items-center">
                ...
                />
                <span className="ml-4 text-lg font-bold">Shaajo's Creation</span>
              </div>
            </a>
          </div>
          {/* <div className="w-auto p-8">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="https://www.facebook.com/profile.php?id=100054356226111">
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.instagram.com/shaajo_official/">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
              ...
              <div className="w-auto p-1.5">
                <Link to="/upload">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400"                  >
                    ...
                    >
                      <path
                        d="M6.39262 1.36494C6.65798 1.16494 7.04262 1.36494 7.24262 1.36494H8.74262C8.94262 1.36494 9.32726 1.16494 9.59262 1.36494L13.7926 4.16494C14.0426 4.35577 14.0426 4.70412 13.7926 4.89494C13.6589 4.9913 13.4747 5.02694 13.2926 4.99494H12.7426V14.3649C12.7426 14.654 12.6351 14.9304 12.4634 15.1021C12.2917 15.2738 12.0153 15.3813 11.7262 15.3813H4.25887C3.96874 15.3813 3.6924 15.2738 3.52071 15.1021C3.34902 14.9304 3.24149 14.654 3.24149 14.3649V4.99494H2.69262C2.51054 5.02688 2.32641 4.99147 2.19262 4.89494C1.94262 4.70412 1.94262 4.35577 2.19262 4.16494L6.39262 1.36494Z"
                        fill="#27272A"
                      ></path>
                      <path
                        d="M7.74262 11.3649H6.74262V9.36494H5.74262V11.3649H4.74262V12.3649H5.74262V14.3649H6.74262V12.3649H7.74262V11.3649Z"
                        fill="#27272A"
                      ></path>
                    </svg>
                  </div>
